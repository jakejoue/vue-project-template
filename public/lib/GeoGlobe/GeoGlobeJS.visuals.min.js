...
function initMarkPointsSet(a){var b=a._legend.itemColors,c=a._legend.itemStatuses,d=a._rendererOptions.markPoint.unactivatedDrawable,e=a._rendererOptions.markPoint.symbol,f=a._rendererOptions.markPoint.symbolSize,g=a._rendererOptions.markPoint.itemStyle,h=function(c,d,e){this.legendLabel=c;this.markPoints=d;for(c=d.length;c--;){d[c].weight=(d[c].value-a.minValue)/(a.maxValue-a.minValue);if(isNaN(d[c].weight))d[c].weight=1;if(d[c].weight>1)d[c].weight=1;if(d[c].weight<0)d[c].weight=0;if(GeoGlobe.Util.getType(a._rendererOptions.markPoint.itemStyle.color[e])===
"object")a.gradientImageData=GeoGlobe.Util.getGradientImageData(a._rendererOptions.markPoint.itemStyle.color[e]);d[c].color=GeoGlobe.Util.getType(g.color[e])==="object"?"rgba("+a.gradientImageData[~~(d[c].weight*255+0.5)*4]+","+a.gradientImageData[~~(d[c].weight*255+0.5)*4+1]+","+a.gradientImageData[~~(d[c].weight*255+0.5)*4+2]+","+a.gradientImageData[3]/255+")":b[e]}};h.prototype.updateXY=function(){for(var b=this.markPoints.length;b--;)if(a._parent.map){var c=a._parent.map.project([this.markPoints[b].lon,
this.markPoints[b].lat]);this.markPoints[b].x=c.x;this.markPoints[b].y=c.y}};h.prototype.draw=function(a,b){if(d||c[b]!==0){var g=[],n=function(a){for(var b=0;b<g.length;b++)if(parseInt(g[b].x)===parseInt(a.x)&&parseInt(g[b].y)===parseInt(a.y))return g[b];return null},h=function(){a.fillStyle=k.color;a.beginPath();switch(e){case "square":a.globalCompositeOperation="lighter";a.rect(k.x-f/2,k.y-f/2,f,f);break;case "square2":a.rect(k.x-f/2,k.y-f/2,f,f);break;case "round":a.globalCompositeOperation="lighter",
a.arc(k.x,k.y,f/2,0,Math.PI*2,!1)}a.fill()},v=this.markPoints.length;for(this.markPoints=this.markPoints.sort(function(a,b){var c=a.value,d=b.value;return c>d?-1:c<d?1:0});v--;){var k;k=this.markPoints[v];if(e==="square2"){var p=n(k);if(p){if(k.value>p.value)h(),p.value=k.value}else h(),g.push({x:k.x,y:k.y,value:k.value})}else h()}}};return h}
...
this._legend.itemSize)+10)*(~~(this.legendLabels.length/this._legend.col)+(this.legendLabels.length%this._legend.col===0?0:1));this.legendCanvas.width=h;this.legendCanvas.height=c;var j=function(a,c,d,e){this.legendCanvas.width=h;for(var f=!1,g,j,u=0,a=a!==void 0?a+1:this.legendLabels.length;u<a;u++){j=0;for(var s=this._legend.col;j<s;j++)if(u%this._legend.col===j){g=10+this._legend.itemSize/2;for(var q=0;q<j;q++)g+=b[q]+10}j=10+this._legend.itemSize/2+((this._legend.itemSize<this._legend.textStyle.fontSize?
this._legend.textStyle.fontSize:this._legend.itemSize)+10)*~~(u/this._legend.col);q=s=!1;this.legendCanvasContext.beginPath();switch(this._rendererOptions.markPoint.symbol){case "square":this.legendCanvasContext.rect(g-this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "square2":this.legendCanvasContext.rect(g-this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "round":this.legendCanvasContext.arc(g,
j,this._legend.itemSize/2,0,Math.PI*2,!1)}c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(f=s=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(q=!0);this.legendCanvasContext.beginPath();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.rect(g+this._legend.itemSize/2+10,
j-this._legend.textStyle.fontSize/2,this.legendCanvasContext.measureText(this.legendLabels[u].toString()).width,this._legend.textStyle.fontSize);c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(f=s=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(q=!0);q&&(this._legend.itemStatuses[u]=this._legend.itemStatuses[u]===0?1:0,this.drawCanvas());var r=this._legend.itemStatuses[u]===0?"#808080":this._legend.itemColors[u]?this._legend.itemColors[u]:
this._rendererOptions.markPoint.itemStyle.color,t=this._legend.itemStatuses[u]===0?"#808080":this._legend.textStyle.color,r=s||q?GeoGlobe.Util.getShadeColor(r,20):r,t=s||q?GeoGlobe.Util.getShadeColor(t,20):t;this.legendCanvasContext.beginPath();switch(this._rendererOptions.markPoint.symbol){case "square":this.legendCanvasContext.rect(g-this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "square2":this.legendCanvasContext.rect(g-this._legend.itemSize/
2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "round":this.legendCanvasContext.arc(g,j,this._legend.itemSize/2,0,Math.PI*2,!1)}this.legendCanvasContext.fillStyle=r;this.legendCanvasContext.fill();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.textAlign="left";this.legendCanvasContext.textBaseline="middle";this.legendCanvasContext.fillStyle=
t;this.legendCanvasContext.fillText(this.legendLabels[u],g+this._legend.itemSize/2+10,j)}this.legendCanvas.style.cursor=f?"pointer":"default"}.bind(this);this.legendCanvas.onmousedown=function(a){var b=a.offsetX||a.clientX-(a.target||a.srcElement).getBoundingClientRect().left,c=a.offsetY||a.clientY-(a.target||a.srcElement).getBoundingClientRect().top;j(void 0,a.type,b,c)};this.legendCanvas.onmousemove=function(a){var b=a.offsetX||a.clientX-(a.target||a.srcElement).getBoundingClientRect().left,c=a.offsetY||
a.clientY-(a.target||a.srcElement).getBoundingClientRect().top;j(void 0,a.type,b,c)};j(a)}},clearCanvas:function(){this.canvas[0].width=this.cacheCanvas[0].width=0},stopDraw:function(){cancelAnimationFrame(this.frame);this.clearCanvas()},destroy:function(){this.stopDraw();this._parent.container.removeChild(this.div);this.MarkPoint=null;this.markPoints=[];this.canvas=[];this.data=[];this.cacheCanvas=[];this.canvasContext=[];this.cacheCanvasContext=[];this._rendererOptions={};if(this._worker)this._worker.terminate(),
this._worker.onmessage=null,delete this._worker;this._blobURL&&window.URL.revokeObjectURL(this._blobURL)},addTo:function(a){this._parent=a;this._parent.addLayer(this);this._parent.container.appendChild(this.div);this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this.div.style.display=a?"block":"none";this.legendDiv&&(this.legendDiv.style.display=
a?"block":"none");a?this.draw():this.stopDraw()},setData:function(a){this.data=a;this.minValue=Number.MAX_VALUE;this.maxValue=Number.MIN_VALUE;for(var b=0;b<a.length;b++){if(a[b].properties.value<this.minValue)this.minValue=a[b].properties.value;if(a[b].properties.value>this.maxValue)this.maxValue=a[b].properties.value}var a=new Blob(["function MarkPoint(lon, lat, value) {this.lon = lon;this.lat = lat;this.value = value;}function MarkPointsSet(legendLabel) {this.legendLabel = legendLabel;this.markPoints = [];}var legendLabels = [];var markPointsSets = [];onmessage = function (evt) {var features = evt.data.data;var feature = null;var legendLabel = null;for (var i = 0, len = features.length; i < len; i++) {feature = features[i];legendLabel = feature.properties.type;if (legendLabels.indexOf(legendLabel) === -1) {legendLabels.push(legendLabel);markPointsSets.push(new MarkPointsSet(legendLabel));}markPointsSets[legendLabels.indexOf(legendLabel)].markPoints.push(new MarkPoint(feature.geometry.coordinates[0], feature.geometry.coordinates[1],feature.properties.value));}postMessage({legendLabels: legendLabels,markPointsSets: markPointsSets})}"]),
a=window.URL.createObjectURL(a),b=new Worker(a),c=this,d=initMarkPointsSet(c);b.onmessage=function(a){c.legendLabels=a.data.legendLabels;c.markPointsSets=[];for(var b=0,g=a.data.markPointsSets.length;b<g;b++){var h=new d(a.data.markPointsSets[b].legendLabel,a.data.markPointsSets[b].markPoints,b);h.updateXY();c.markPointsSets.push(h)}c.DRAWINDEX=0;c.lazydraw()};b.postMessage({data:this.data});this._blobURL=a;this._worker=b}});
...
[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.canvas[0].style.position="absolute";this.div.appendChild(this.canvas[0])},_initTooltip:function(){if((this._rendererOptions.markPoint.hoverable||this._rendererOptions.markPoint.clickable)&&this._rendererOptions.tooltip.show)this.tooltipDiv=
this.tooltipDiv||this.div.appendChild(document.createElement("div")),this.tooltipDiv.style.position="relative",this.tooltipDiv.style.display="none",this.tooltipDiv.style.zIndex=999,this.tooltipDiv.style.width="max-content",this.tooltipDiv.style.color=this._rendererOptions.tooltip.textStyle.color,this.tooltipDiv.style.padding=this._rendererOptions.tooltip.padding+"px",this.tooltipDiv.style.font=this._rendererOptions.tooltip.textStyle.fontStyle+" "+this._rendererOptions.tooltip.textStyle.fontWeight+
" "+this._rendererOptions.tooltip.textStyle.fontSize+"px "+this._rendererOptions.tooltip.textStyle.fontFamily,this.tooltipDiv.style["background-color"]=document.createElement("canvas").getContext?this._rendererOptions.tooltip.backgroundColor:GeoGlobe.Util.getRgbColor(this._rendererOptions.tooltip.backgroundColor),this.tooltipDiv.style["border-width"]=this._rendererOptions.tooltip.borderWidth+"px",this.tooltipDiv.style["border-color"]=this._rendererOptions.tooltip.borderColor,this.tooltipDiv.style["border-radius"]=
...
!1;this.redraw()},onClick:function(a){this.visibility&&this._rendererOptions.markPoint.clickable&&this.hoveredMarkPoint&&this._parent.fire("overlayerclick",{layer:this,feature:this.hoveredMarkPoint,event:a})},onMouseMove:function(a){this.visibility&&this._rendererOptions.markPoint.hoverable&&this.markPointsSets.length>0&&!this._parent.map.moving&&(this.hover(a.point.x,a.point.y),this.hoveredMarkPoint&&this._parent.fire("overlayerhover",{layer:this,feature:this.hoveredMarkPoint,event:a}))},onMoveEnd:function(){this.redraw()},
...
"px";this.legendDiv.style["border-style"]="solid";this.legendDiv.style["box-shadow"]=this._legend.shadowOffsetX+"px "+this._legend.shadowOffsetY+"px "+this._legend.shadowBlur+"px "+this._legend.shadowColor;this.legendDiv.style.padding=this._legend.padding+"px";this.legendDiv.style.left=this._legend.left!==null?this._legend.left+"px":null;this.legendDiv.style.right=this._legend.right!==null?this._legend.right+"px":null;this.legendDiv.style.top=this._legend.top!==null?this._legend.top+"px":null;this.legendDiv.style.bottom=
this._legend.bottom!==null?this._legend.bottom+"px":null;this.legendCanvas=document.createElement("canvas");this.legendCanvasContext=this.legendCanvas.getContext("2d");this.legendCanvas.style.display="block";this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendDiv.appendChild(this.legendCanvas);this.div.appendChild(this.legendDiv);for(var b=[],c=null,d=0,e=this.legendLabels.length;d<
e;d++)for(var c=this._legend.itemSize+10+this.legendCanvasContext.measureText(this.legendLabels[d].toString()).width,f=this._legend.col,g=0;g<f;g++)d%this._legend.col===g&&(!b[g]||b[g]<c)&&(b[g]=c);for(var h=10,c=10,d=0,e=b.length;d<e;d++)h+=b[d]+10;c+=((this._legend.itemSize<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemSize)+10)*(~~(this.legendLabels.length/this._legend.col)+(this.legendLabels.length%this._legend.col===0?0:1));this.legendCanvas.width=h;this.legendCanvas.height=
c;var j=function(a,c,d,e){this.legendCanvas.width=h;for(var a=!1,f,g,j=0,u=this.legendLabels.length;j<u;j++){g=0;for(var s=this._legend.col;g<s;g++)if(j%this._legend.col===g){f=10+this._legend.itemSize/2;for(var q=0;q<g;q++)f+=b[q]+10}g=10+this._legend.itemSize/2+((this._legend.itemSize<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemSize)+10)*~~(j/this._legend.col);q=s=!1;this.legendCanvasContext.beginPath();switch(this._legend.symbol){case "ring":this.legendCanvasContext.arc(f,
g,this._legend.itemSize/2,0,Math.PI*2,!1);break;case "circle":this.legendCanvasContext.arc(f,g,this._legend.itemSize/2,0,Math.PI*2,!1)}c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(a=s=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(q=!0);this.legendCanvasContext.beginPath();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+
this._legend.textStyle.fontFamily;this.legendCanvasContext.rect(f+this._legend.itemSize/2+10,g-this._legend.textStyle.fontSize/2,this.legendCanvasContext.measureText(this.legendLabels[j].toString()).width,this._legend.textStyle.fontSize);c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(a=s=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(q=!0);q&&(this._legend.itemStatuses[j]=this._legend.itemStatuses[j]===0?1:0,this.drawCanvas());
var r=this._legend.itemColors[j],t=this._legend.textStyle.color,r=s||q?GeoGlobe.Util.getShadeColor(r,20):r,t=s||q?GeoGlobe.Util.getShadeColor(t,20):t;this.legendCanvasContext.beginPath();switch(this._legend.symbol){case "ring":this.legendCanvasContext.arc(f,g,this._legend.itemSize/2,0,Math.PI*2,!1);break;case "circle":this.legendCanvasContext.arc(f,g,this._legend.itemSize/2,0,Math.PI*2,!1)}this.legendCanvasContext.fillStyle=r;this.legendCanvasContext.fill();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+
" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.textAlign="left";this.legendCanvasContext.textBaseline="middle";this.legendCanvasContext.fillStyle=t;this.legendCanvasContext.fillText(this.legendLabels[j],f+this._legend.itemSize/2+10,g)}this.legendCanvas.style.cursor=a?"pointer":"default"}.bind(this);this.legendCanvas.onmousedown=function(a){var b=a.offsetX||a.clientX-(a.target||a.srcElement).getBoundingClientRect().left,
c=a.offsetY||a.clientY-(a.target||a.srcElement).getBoundingClientRect().top;j(void 0,a.type,b,c)};this.legendCanvas.onmousemove=function(a){var b=a.offsetX||a.clientX-(a.target||a.srcElement).getBoundingClientRect().left,c=a.offsetY||a.clientY-(a.target||a.srcElement).getBoundingClientRect().top;j(void 0,a.type,b,c)};j(a)}},drawLegend2:function(){if(this._legend_rightop&&this._legend_rightop.show){if(!this.legendDiv2)this.legendDiv2=document.createElement("div"),this.legendDiv2.style.position="absolute",
this.legendDiv2.style["background-color"]=this._legend.backgroundColor,this.legendDiv2.style["border-color"]=this._legend.borderColor,this.legendDiv2.style["border-width"]=this._legend.borderWidth+"px",this.legendDiv2.style["border-radius"]=this._legend.borderRadius+"px",this.legendDiv2.style["border-style"]="solid",this.legendDiv2.style["box-shadow"]=this._legend.shadowOffsetX+"px "+this._legend.shadowOffsetY+"px "+this._legend.shadowBlur+"px "+this._legend.shadowColor,this.legendDiv2.style.padding=
this._legend.padding+"px",this.legendDiv2.style.left=this._legend_rightop.left!==null?this._legend_rightop.left+"px":null,this.legendDiv2.style.right=this._legend_rightop.right!==null?this._legend_rightop.right+"px":null,this.legendDiv2.style.top=this._legend_rightop.top!==null?this._legend_rightop.top+"px":null,this.legendDiv2.style.bottom=this._legend_rightop.bottom!==null?this._legend_rightop.bottom+"px":null,this.legendCanvas2=document.createElement("canvas"),this.legendCanvasContext2=this.legendCanvas2.getContext("2d"),
this.legendCanvas2.style.display="block",this.legendCanvasContext2.font=this._legend_rightop.textStyle.fontStyle+" "+this._legend_rightop.textStyle.fontWeight+" "+this._legend_rightop.textStyle.fontSize+"px "+this._legend_rightop.textStyle.fontFamily,this.legendDiv2.appendChild(this.legendCanvas2),this.div.appendChild(this.legendDiv2);for(var a=[],b=null,c=0,d=this._legend_rightop.vLegendLabels.length;c<d;c++)for(var b=this._legend_rightop.itemWidth+10+this.legendCanvasContext2.measureText(this._legend_rightop.vLegendLabels[c].toString()).width,
e=this._legend_rightop.col,f=0;f<e;f++)c%this._legend_rightop.col===f&&(!a[f]||a[f]<b)&&(a[f]=b);b=10;c=0;for(d=a.length;c<d;c++)b+=a[c]+10;this.legendCanvas2.width=b;this.legendCanvas2.height=this._legend_rightop.itemHeight;(function(){var b,d,e=0;for(d=this._legend_rightop.col;e<d;e++)if(c%this._legend_rightop.col===e){b=10+this._legend_rightop.itemSize/2;for(var f=0;f<e;f++)b+=a[f]+10}d=this._legend_rightop.itemSize/2+((this._legend_rightop.itemSize<this._legend_rightop.textStyle.fontSize?this._legend_rightop.textStyle.fontSize:
this._legend_rightop.itemSize)+10)*~~(c/this._legend_rightop.col);var f=this._rendererOptions.markPoint.itemStyle.color,m=this._legend_rightop.textStyle.color;this.legendCanvasContext2.beginPath();this.legendCanvasContext2.arc(b,d,this._legend_rightop.itemSize_circle[0]/2,0,Math.PI*2,!1);this.legendCanvasContext2.fillStyle=f;this.legendCanvasContext2.fill();for(e=0;e<4;)this.legendCanvasContext2.beginPath(),this.legendCanvasContext2.arc(b,d,this._legend_rightop.itemSize_circle[e]/2,0,Math.PI*2,!1),
this.legendCanvasContext2.strokeStyle=f,this.legendCanvasContext2.stroke(),e++;this.legendCanvasContext2.font=this._legend_rightop.textStyle.fontStyle+" "+this._legend_rightop.textStyle.fontWeight+" "+this._legend_rightop.textStyle.fontSize+"px "+this._legend_rightop.textStyle.fontFamily;this.legendCanvasContext2.textAlign="left";this.legendCanvasContext2.textBaseline="middle";this.legendCanvasContext2.fillStyle=m;this.legendCanvasContext2.fillText(this._legend_rightop.vLegendLabels[0],b+this._legend_rightop.itemWidth/
2+10,d);this.legendCanvasContext2.beginPath();this.legendCanvasContext2.arc(b+(this._legend_rightop.itemWidth+10)*2,d,this._legend_rightop.itemSize_ringBig[0]/2,0,Math.PI*2,!1);this.legendCanvasContext2.fillStyle=f;this.legendCanvasContext2.fill();for(e=0;e<3;)this.legendCanvasContext2.beginPath(),this.legendCanvasContext2.arc(b+(this._legend_rightop.itemWidth+10)*2,d,this._legend_rightop.itemSize_ringBig[e]/2,0,Math.PI*2,!1),this.legendCanvasContext2.fillStyle=f,this.legendCanvasContext2.fill(),
e++;this.legendCanvasContext2.font=this._legend_rightop.textStyle.fontStyle+" "+this._legend_rightop.textStyle.fontWeight+" "+this._legend_rightop.textStyle.fontSize+"px "+this._legend_rightop.textStyle.fontFamily;this.legendCanvasContext2.textAlign="left";this.legendCanvasContext2.textBaseline="middle";this.legendCanvasContext2.fillStyle=m;this.legendCanvasContext2.fillText(this._legend_rightop.vLegendLabels[1],b+(this._legend_rightop.itemWidth+10)*2+15,d);this.legendCanvasContext2.beginPath();this.legendCanvasContext2.arc(b+
(this._legend_rightop.itemWidth+10)*4,d,this._legend_rightop.itemSize_ringSmall[0]/2,0,Math.PI*2,!1);this.legendCanvasContext2.fillStyle=f;this.legendCanvasContext2.fill();for(e=0;e<3;)this.legendCanvasContext2.beginPath(),this.legendCanvasContext2.arc(b+(this._legend_rightop.itemWidth+10)*4,d,this._legend_rightop.itemSize_ringSmall[e]/2,0,Math.PI*2,!1),this.legendCanvasContext2.fillStyle=f,this.legendCanvasContext2.fill(),e++;this.legendCanvasContext2.font=this._legend_rightop.textStyle.fontStyle+
" "+this._legend_rightop.textStyle.fontWeight+" "+this._legend_rightop.textStyle.fontSize+"px "+this._legend_rightop.textStyle.fontFamily;this.legendCanvasContext2.textAlign="left";this.legendCanvasContext2.textBaseline="middle";this.legendCanvasContext2.fillStyle=m;this.legendCanvasContext2.fillText(this._legend_rightop.vLegendLabels[2],b+(this._legend_rightop.itemWidth+10)*4+13,d)}).bind(this)()}},clearCanvas:function(){this.canvas[0].width=this.cacheCanvas[0].width=this.width},stopDraw:function(){cancelAnimationFrame(this.frame);
this.clearCanvas()},destroy:function(){this.stopDraw();this._parent.container.removeChild(this.div);this.MarkPoint=null;this.markPoints=[];this.canvas=[];this.data=[];this.cacheCanvas=[];this.canvasContext=[];this.cacheCanvasContext=[];this._rendererOptions={}},hover:function(a,b){this.hoveredMarkPoint=null;for(var c=0,d=this.markPointsSets.length;c<d;c++)!this.hoveredMarkPoint&&this.markPointsSets[c].isPointInPath(this.cacheCanvasContext[0],a,b);this.drawCanvas();this.hoveredMarkPoint?(this.canvas[0].style.cursor=
"pointer",this.showTooltip(this.hoveredMarkPoint.category,a,b)):(this.canvas[0].style.cursor="grab",this.hideTooltip())},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=a,this.tooltipDiv.style.top=c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display="none"},addTo:function(a){this._parent=a;this._parent.addLayer(this);this._parent.container.appendChild(this.div);
this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this.div.style.display=a?"block":"none";this.legendDiv&&(this.legendDiv.style.display=a?"block":"none");a?this.draw():this.stopDraw()},setData:function(a){this.data=a;a=new Blob(["function MarkPoint(lon, lat, value) {this.lon = lon;this.lat = lat;this.value = value;}function MarkPointsSet(legendLabel) {this.legendLabel = legendLabel;this.markPoints = [];}var legendLabels = [];var markPointsSets = [];onmessage = function (evt) {var features = evt.data.data;var feature = null;var legendLabel = null;for (var i = 0, len = features.length; i < len; i++) {feature = features[i];legendLabel = feature.properties.type;if (legendLabels.indexOf(legendLabel) === -1) {legendLabels.push(legendLabel);markPointsSets.push(new MarkPointsSet(legendLabel));}markPointsSets[legendLabels.indexOf(legendLabel)].markPoints.push(new MarkPoint(feature.geometry.coordinates[0], feature.geometry.coordinates[1],feature.properties.value));}postMessage({legendLabels: legendLabels,markPointsSets: markPointsSets})}"]);
